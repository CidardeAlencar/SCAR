...
import 'package:scar/widgets/container_list_widget.dart';

// import 'package:flutter_speed_dial/flutter_speed_dial.dart';
//import 'package:firebase_auth/firebase_auth.dart';
// Si es una clase empieza con mayuscula
//  import 'package:cloud_firestore/cloud_firestore.dart';
const List<String> pat = <String>[
  //'TODO',
  'EJTO',
  'AB',
  'FAB'
...
class WeaponScreen extends StatefulWidget {
  const WeaponScreen({Key? key, required this.onItemSelected})
      : super(key: key);
...
class _WeaponScreenState extends State<WeaponScreen> {
  ...
  String _selectedOption = pat.first;
      ...
      body: Padding(
          ...
          child: Column(
            children: [
              ...
              //   child: Stack(
              //     children: [
              //       Image.asset('assets/icon _star.png'),
              //     ],
              //   ),
              // ),
              // Text(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          ...
                          print('Botón registro de armamento');
                          Navigator.pushNamed(context, '/registerWeapons');
                          ...
                          onChanged: (String? newValue) {
                            setState(() {
                              ...
                              widget.onItemSelected(
                                  _selectedOption); // Pasar el índice seleccionado al callback
                            });
                          },
                          items: pat
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              children: [
                                ...
                                WeaponListWidget(filter: _selectedOption),
